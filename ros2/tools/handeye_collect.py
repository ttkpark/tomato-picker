...
# ⚠ 2026-09-04 확정: 09-03 새벽 표본 7개(~/handeye_samples.json)를
#   handeye_resolve.py로 다시 풀어 보니 +1은 벽 법선 어긋남 평균 93.8°,
#   -1은 11.4°였다 — 반대 부호가 압도적으로 맞다. 그동안 이 값이 +1로
#   박혀 있어 손-눈 보정이 안 풀렸을 수 있다.
WANT_POSES = 16
